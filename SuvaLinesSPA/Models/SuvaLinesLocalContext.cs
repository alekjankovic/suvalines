...
{
    public partial class SuvaLinesLocalContext : DbContext
    {
        public SuvaLinesLocalContext()
        {
        }

        public SuvaLinesLocalContext(DbContextOptions<SuvaLinesLocalContext> options)
            : base(options)
        {
        }
